...
exports.TimeSeries = exports.Statistics = exports.TechnicalIndicators = void 0;
/**
...
class TimeSeries {
     ...
     */
    static detectTrend(values, period = 20) {
     ...
     */
    static findSupportResistance(highs, lows, period = 20) {
        const recentHighs = highs.slice(-period);
        const recentLows = lows.slice(-period);
     ...
     */
    static volatilityRegime(values, shortPeriod = 10, longPeriod = 30) {
     ...
     */
    static maCrossover(prices, fastPeriod = 10, slowPeriod = 20) {
